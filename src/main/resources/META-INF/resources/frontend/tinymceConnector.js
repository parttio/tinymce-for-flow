window.Vaadin.Flow.tinymceConnector = {
    initLazy: function (customConfig, c, ta, options, initialHtml) {
        ...
        c.$connector = {
          ...
          acknowledge : function(syncedIdx) {
              if(idx == syncedIdx) {
                // no new changes since last update, change the diff base
                this.html = this.syncedHtml;
                  // return ok for server, it can make new diff base from
                  // current value
                  return "ok";
              } else {
                  // Somebody was quick and new messages on the way to server already!!
                  return "mismatch!";
              }
          },
        ...
        baseconfig['setup'] = function(ed) {
          ...
          function computePatch() {
            ...
            console.log("PT size:" + patch_text.length);
...
// Apache 2 licenced diff_match_patch.js
